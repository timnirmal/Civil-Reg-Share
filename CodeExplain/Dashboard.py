# First Libararies are imported
import sqlite3              # This is the SQLite database library for working with the database
from datetime import date
from tkinter import *       # This is the Tkinter library for creating the GUI
from tkinter import filedialog

# From lib module import FingerPrintScan function we made Earlier
from lib import FingerPrintScan

# Set variable to Folder containing the images which we use as input for the fingerprint scanner in Dashboard
openFilePath = r"C:\Users\timni\PycharmProjects\Civil-Register\Data\Altered\SelectedData"

# Set of variables for Update GUI components
newFingerPrint = ""
labelFingerPrint = None

newName = ""        # Variable for store the name of the person
labelName = None    # Variable for store the label Component
...
def updateData():
    global newName, labelName       # global variables
    ...
    newName = dataPerson[2]                     # Set Name from the Person table in Database
    ...
    if newName is not None:
        labelName.configure(text=newName)               # Set the label text to the new Name
...
if __name__ == '__main__':
    ...
    # Label Right to Name (Name : ) to show name (Variable) in x=600 y=96 size=200x48 show name
    # Label Component for name (In middle frame, text variable is name, font is arial, size is 15, color is black, background is white)
    labelName = Label(middle, text=newName, font=('arial', 15), fg='black', bg='white')
    # Place the label in x=600, y=96 location
